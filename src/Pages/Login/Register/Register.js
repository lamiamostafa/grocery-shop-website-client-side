    ...
    return (
        <div className='register-form'>
            ...
            <form onSubmit={handleRegister}>
                <input type="text" name="name" style={{ textTransform: "capitalize" }} id="" placeholder='Your Name' required />
                <input type="email" name="email" style={{ textTransform: "lowercase" }} id="" placeholder='Your Email' required />
